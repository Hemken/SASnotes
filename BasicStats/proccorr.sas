 *- A subset of Anderson's famous iris data, on iris setosa ----*
   ...
   *------------------------------------------------------------*;
* Sepals are the drooping "falls", petals are the upright "standards";
* from "SAS Procedures, PROC CORR, Example 2.2";
data Setosa;
